...
export const rest_auth_password_reset_create = createAsyncThunk(
  "passwordResets/rest_auth_password_reset_create",
  async payload => {
...
const passwordResetsSlice = createSlice({
  name: "passwordResets",
  initialState,
  reducers: {},
  extraReducers: {
...
export default { rest_auth_password_reset_create, slice: passwordResetsSlice }
